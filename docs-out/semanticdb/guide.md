...
[Metabrowse](#metabrowse) and [Metals](#metals) don't need to know about compiler
...
Caveats:
  ...
  * At the moment, SemanticDB-based tools are responsible for implementing discovery of
    ...
    reproduced by Scalafix, Metabrowse and others. We are planning to
...
[Metabrowse](https://github.com/scalameta/metabrowse) is an experiment with SemanticDB
to build online code browser with IDE-like features. Check out
[the demo](http://scalameta.org/metabrowse/) for more information.

Metabrowse takes Scala sources and corresponding SemanticDB files generated by
...
Thanks to SemanticDB, Metabrowse is:
  * **Cross-platform**: [Scala bindings to SemanticDB](#scala-bindings) are
    ...
    SemanticDB payloads.
  * **Portable**: Just like Scalafix, Metabrowse is not tied to compiler internals,
...
Thanks to SemanticDB, Metals is:
  * **Mostly portable**: Unlike Scalafix and Metabrowse, Metals has modules that
